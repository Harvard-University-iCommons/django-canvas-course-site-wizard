    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bulk_job_id', models.IntegerField(db_index=True)),
                ('school_id', models.CharField(max_length=10)),
                ('sis_term_id', models.IntegerField()),
                ('status', models.CharField(default=b'setup', max_length=30, choices=[(b'setup', b'setup'), (b'pending', b'pending'), (b'finalizing', b'finalizing'), (b'notification_successful', b'notification_successful'), (b'notification_failed', b'notification_failed')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow_state', models.CharField(default=b'queued', max_length=20, choices=[(b'queued', b'queued'), (b'running', b'running'), (b'completed', b'completed'), (b'failed', b'failed')])),
                ('created_by_user_id', models.CharField(max_length=20)),
