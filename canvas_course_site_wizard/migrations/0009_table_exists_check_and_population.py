...
from canvas_course_site_wizard.migrations.migration_data import data_population_0009

CANVAS_SCHOOL_TEMPLATE_DATA = data_population_0009.CANVAS_SCHOOL_TEMPLATE_DATA
...
def load_school_template_data(apps, schema_editor):
    ...
    for canvas_school_template in CANVAS_SCHOOL_TEMPLATE_DATA:
        CanvasSchoolTemplate.objects.get_or_create(**dict(list(zip(fields, canvas_school_template))))
